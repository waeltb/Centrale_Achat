...
public class ProductServiceImpl implements ProductService {
    ...
    private final OrederRepo orderRepo;
    ...
    public Product save(String name, float price, int qte, String description, int minStock, int idCategory, MultipartFile file, int idUser) throws IOException {
        ...
        Files.copy(file.getInputStream(), Path.of("src/main/resources/imageProduct/" + file.getOriginalFilename()), StandardCopyOption.REPLACE_EXISTING);
